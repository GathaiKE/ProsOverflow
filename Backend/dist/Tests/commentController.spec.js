...
(0, vitest_1.describe)('Comment tests', () => {
    ...
    //Delete comment
    (0, vitest_1.it)('Should delete a selected comment', () => {
        return (0, supertest_1.default)(server_1.default).delete('/comments/delete/cd75d588-e257-465d-858c-55ff9df8c274')
            .expect('Content-Type', /json/)
            .set('token', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..YnOQIc9p-B_KT8qyYqr25bHuc6pdzQpVCAn4i-z59jA')
            .expect(200)
            .then((res) => {
